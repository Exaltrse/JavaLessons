package DZ1_BaseTypesAndFunctions;
...
public final class Zadanija {
    ...
    public static double Zadanije1_VesNaLune(double ves) {
        return (ves * 0.16);
    }
    ...
    public static void Zadanije2_Array(int[] anArray) {
    ...
    public static boolean Zadanije3_Palindrom(int number) {
    ...
    public static void Zadanije4_Even100() {
        for (int i = 1; i <= 100; i++) {
    ...
    public static void Zadanije5_Odd15() {
        for (int i = 1; i <= 15; i++) {
            if (i % 2 != 0) System.out.print(i + "\t");
        }
    }
    ...
    public static void Zadanije6_EvenFor() {
    ...
    public static void Zadanije7_SumFor() {
        int sum = 0;
    ...
    public static void Zadanije8_Year() {
    ...
    public static void Zadanije9_Rearrangement() {
        int i1 = 5, i2 = 9, tmp = 0;
    ...
    public static void Zadanije10_SumTiPrint(int int1, int int2) {
        int int3 = int1 + int2;
    ...
    public static int Zadanije11_Max(int int1, int int2, int int3) {
        if (int1 >= int2) {
            if (int3 > int1) {
                return int3;
            } else {
    ...
    public static void Zadanije12_BoolToString() {
        boolean bool1 = true;
        boolean bool2 = false;
    ...
    public static String Z12_Support(boolean bool) {
        if (bool) {
            return "истина";
        }
        return "ложь";
    ...
    public static void Zadanije13_Concat() {
    ...
    public static void Zadanije14_Calculate() {
        int int1 = 65;
        int int2 = 128;
    ...
    //while
    //do while
    public static void Zadanije15_Loops() {
        int i = 1;
    ...
    public static void Zadanije16_Print(int startNumber, int finishNumber, int shag) {
    ...
    public static void Zadanije17_Array(double[] anArray) {
    ...
    public static double Zadanije18_Currencu(double rubli, double course) {
        return rubli * course;
    }

    //Напишите программу, которая будет считать количество часов, минут и секунд в n-ном количестве суток.
    public static void Advanced_Calculate(int sutok) {
        long hours = sutok * 24;
        long min = hours * 60;
        long sec = min * 60;
