...
public class Car extends AbstractComponent implements Nameble {

    private static String manufacturer;

    //Подумтаь, как увязать между собой классы.
...
//    private VehicleInterior vehicleInterior;
    ...
    public static Car RandomCar() {
        Car car = new Car();
        car.setComponents((Components) new Components().toClone());
