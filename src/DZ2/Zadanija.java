...
public final class Zadanija {
    ...
    public static String[] Task1_Sort(String[] strArray) {
    ...
    private static String[] IteratingCopfy(String[] stringArray) {
    ...
    private static boolean SmallerString(String string1, String string2) {
    ...
    public static long Task2_Sum(int[] intArray) {
        long sum = 0;
        for (int i : intArray) {
            sum += i;
        }
    ...
    public static int Task6_FirstIndexOf(int[] intArray, int sample) {
    ...
    public static int[] Task7_Remove(int[] intArray, int indexToRemove) {
    ...
    public static int[] Task8_ArrayIteratingCopy(int[] intArray) {
    ...
    public static int[] Task9_InsertValueToIndex(int[] intArray, int indexForInsert, int valueToInsert) {
    ...
    public static void Task10_MaxAndMinValue(int[] intArray) {
    ...
    public static int[] Task11_Reverse(int[] intArray) {
        int[] tmpArray = new int[intArray.length];
    ...
    public static int[] Task12_FindDuplicates(int[] intArray) {
    ...
    public static String[] Task13_DuplicatesStrings(String[] stringArray) {
    ...
    private static boolean ContainString(String[] sArray, String string) {
        for (String s : sArray) {
    ...
    public static String[] RemoveIndexFromArray(String[] arr, int index) {
    ...
    public static String[] AddIndexToArray(String[] arr, int index, String value) {
        if (index > arr.length) return null;
        String[] tmpArray = new String[arr.length + 1];
        for (int i = 0, k = 0; i < tmpArray.length; i++, k++) {
            if (i == index) {
    ...
    public static String[] Task14_Compare(String[] stringArray1, String[] stringArray2) {
        String[] results = new String[0];
    ...
    public static int[] Task15_Common(int[] intArray1, int[] intArray2) {
    ...
    public static int[] Task16_RemoveDuplicates(int[] intArray) {
    ...
    public static int Task17_SecondLargest(int[] intArray) {
        int[] tmpArray = Task8_ArrayIteratingCopy(intArray);
    ...
    public static int Task18_SecondSmallest(int[] intArray) {
        int[] tmpArray = Task8_ArrayIteratingCopy(intArray);
    ...
    public static void Task19_Add2Matrices() {
        int a = 15;
    ...
    public static ArrayList<Integer> Task20(int[] intArray) {
    ...
    public static int[] CreateRandomIntArray(int numberOvElements) {
