...
public class Zadanija
{
    ...
    public void Task7_Remove(int[] intArray, int indexToRemove)
    {
        if(!(intArray.length<=indexToRemove)) return;
    ...
    public void Task9_InsertValueToIndex(int[] intArray, int indexForInsert, int valueToInsert)
    {
        if(intArray.length<indexForInsert) return;
    ...
    public void Task11_Reverse(int[] intArray)
    {
        int[] tmpArray = new int[intArray.length];
    ...
    public int[] Task12_FindDuplicates(int[] intArray)
    {
        ...
        for(int i=0; i<tmpArray.length;i++)
        {
            ...
            Task7_Remove(temporayArray, i);
            if(Task5_Contains(temporayArray,tmpArray[i])) Task9_InsertValueToIndex(resultArray, resultArray.length,tmpArray[i]);
    ...
    public String[] Task13_DuplicatesStrings(String[] stringArray)
    {
        ...
        for(int i=0; i<(stringArray.length-1);i++)
        {
            ...
            RemoveIndexFromArray(tmpArray, i);
            if(ContainString(tmpArray,tmpStringArray[i])) AddIndexToArray(results,results.length,tmpStringArray[i]);
        }
        return results;
    }
    ...
    private void RemoveIndexFromArray(Object[] arr, int index)
    {
        Object[] tmpArray = new Object[arr.length-1];
    ...
    private void AddIndexToArray(Object[] arr, int index, Object value)
    {
        Object[] tmpArray = new Object[arr.length+1];
        for(int i=0,k=0;i<tmpArray.length;i++,k++)
        {
    ...
    public String[] Task14_Compare(String[] stringArray1, String[] stringArray2)
    {
        ...
        {
            if(ContainString(stringArray2,s)) AddIndexToArray(results,results.length,s);
        }
        return results;
    }
    ...
    public int[] Task15_Common(int[] intArray1, int[] intArray2)
    {
        ...
        for(int i:intArray1)
        {
            ...
            if(Task5_Contains(intArray2, i)) Task9_InsertValueToIndex(resultsArray, resultsArray.length,i);
        }
        return resultsArray;
    }
    ...
    public int Task17_SecondLargest(int[] intArray)
    {
        ...
        {
            Task7_Remove(tmpArray, Task6_FirstIndexOf(tmpArray,max));
        }
    ...
    public int Task18_SecondSmallest(int[] intArray)
    {
        ...
        {
            Task7_Remove(tmpArray, Task6_FirstIndexOf(tmpArray,min));
        }
